...
Matrix4 
rotate(const Radian& _angle, const Vector3& _v)
{
...
//Note(mate): 2D
Matrix4
ortho(float _left, float _right,
...
Matrix4 
perspective(const Radian& _fovy, f32 _aspect,
			float _zNear, float _zFar)
{
...
Matrix4
infinitePerspective(const Radian& _fovy, f32 _aspect, f32 _zNear)
{
...
Matrix4
lookAt(const Vector3& _eye, const Vector3& center, const Vector3& up)
{
